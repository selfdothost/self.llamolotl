...
#define COMMON_ARG_PRESET_VRAM_FOOTPRINT_MIB "__PRESET_VRAM_FOOTPRINT_MIB"
#define COMMON_ARG_PRESET_VRAM_SHED_MIB_PER_LAYER "__PRESET_VRAM_SHED_MIB_PER_LAYER"
